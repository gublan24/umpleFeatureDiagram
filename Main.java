 ...
 */
// line 6 "EasyFeatureSPL.ump"
// line 18 "EasyFeatureSPL.ump"
// line 20 "EasyFeatureSPL.ump"
// line 30 "EasyFeatureSPL.ump"
public class Main
{
  ...
  // line 8 "EasyFeatureSPL.ump"
   public static  void main(String [] args){
    Thread.currentThread().setUncaughtExceptionHandler(new Main.UmpleExceptionHandler());
    Thread.setDefaultUncaughtExceptionHandler(new Main.UmpleExceptionHandler());
    Hello_label:
...
System.out.print (" wonderful ");
  ...
  //The following methods Map Java lines back to their original Umple file / line    
    public UmpleSourceData Main_main(){ return new UmpleSourceData().setFileNames("EasyFeatureSPL.ump").setUmpleLines(7).setJavaLines(35).setLengths(10);}
